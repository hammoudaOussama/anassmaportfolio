  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'anassmaqboul06@gmail.com',
    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          {/* Contact Info */}
          <div>
            <h3 className="text-2xl font-bold mb-8 text-orange-400">Get In Touch</h3>
            ...
            {/* Availability Status */}
            <div className="p-6 bg-gradient-to-r from-orange-600/10 to-orange-800/10 rounded-lg border border-orange-500/20">
              <div className="flex items-center mb-2">
                <div className="w-3 h-3 bg-green-400 rounded-full mr-3 animate-pulse"></div>
                <span className="text-orange-400 font-semibold">Available for Coaching</span>
              </div>
              <p className="text-gray-300 text-sm">
                I'm currently available for in-person and remote coaching. Let's discuss your goals and build a plan that works for you.
              </p>
            </div>
          </div>
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full py-3 px-6 rounded-lg font-medium transition-all duration-300 flex items-center justify-center ${isSubmitting
                  ...
                  : 'bg-gradient-to-r from-orange-600 to-orange-800 hover:from-orange-700 hover:to-orange-900 transform hover:scale-105'
                  } text-white`}
              >
                {isSubmitting ? (
                  <>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#"
              className="px-8 py-3 bg-gradient-to-r from-orange-600 to-orange-800 text-white rounded-lg hover:from-orange-700 hover:to-orange-900 transition-all duration-300 transform hover:scale-105"
              target="_blank"
              rel="noopener noreferrer"
            >
              📅 Schedule a Call
            ...
            <a
              href="mailto:anassmaqboul06@gmail.com?subject=Quick Question"
              className="px-8 py-3 border-2 border-orange-400 text-orange-400 rounded-lg hover:bg-orange-400 hover:text-white transition-all duration-300"
            >
              ✉️ Quick Email
            </a>
          </div>
